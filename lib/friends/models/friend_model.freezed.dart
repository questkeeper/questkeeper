...
mixin _$Friend {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, userId, username, points);

  @override
  String toString() {
    return 'Friend(userId: $userId, username: $username, points: $points)';
  }
}
...
extension FriendPatterns on Friend {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Friend() when $default != null:
        return $default(_that.userId, _that.username, _that.points);
      case _:
        return orElse();
    }
  }
...
class _Friend implements Friend {
  const _Friend(
      {required this.userId, required this.username, required this.points});
