    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          _distinctListTiles(
            key: "backgroundsIsSet",
            title: "Clear the backgroundsIsSet flag",
            onTap: () async => await prefs.remove('backgroundsIsSet'),
            description: "Clears the backgroundsIsSet flag",
          ),
          _distinctListTiles(
            key: "allBackgrounds",
            title: "Clear all backgrounds",
            onTap: () async {
              ...
              if (metadataJson == null ||
                  !metadataJson.containsKey("backgroundTypes")) {
              ...
              await Future.wait<void>(
                metadataJson["backgroundTypes"].map<Future<void>>((bg) async {
                  try {
                    ...
                    debugPrint(
                        'Error setting background for ${bg["name"]}: $e');
                  }
                }).toList(), // Convert Iterable to List
              );
            },
            description: "Clears all backgrounds",
          ),
        ],
      ),
    );
